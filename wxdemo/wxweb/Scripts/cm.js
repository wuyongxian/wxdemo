; (function () {
    window.CM = window.CM || {
        ...
        /*end para*/
        /*function*/
         url_area : '',//当前页面 默认的area
         url_controller : '',//当前页面默认提交的controller
         url_action : '',//当前页面默认提交的action
    ...
    /*-----------------------------------------------html方法---------------------------------*/
        ...
        getUrl: function (url_area, url_controller, url_action) {
            return '/' + url_area + '/' + url_controller + '/' + url_action; 
        },
        //获取页面url
