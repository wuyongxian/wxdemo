...
{
    public class resMsg_textController : Controller
    {
        ...
        {
            string resMessageType = "text";//回复消息形式为:text
        ...
        public JsonResult Create(wxmsmResponse item)
        {
            ...
            item.resMessageType = "text";//默认回复的为文字消息
        ...
        public JsonResult EditItem(wxmsmResponse para)
        {
            ...
            try
            {
                ...
                item.msgContent = para.msgContent;
                item.sort = para.sort;
